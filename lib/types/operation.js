...
Operation.prototype.urlify = function (args, maskPasswords) {
  ...
  for (var i = 0; i < this.parameters.length; i++) {
    ...
    if (typeof args[param.name] !== 'undefined') {
      ...
      if (param.in === 'path') {
      ...
      } else if ((param.in === 'query' || (param.in === 'body' && (this.method === 'get' || this.method === 'delete'))) && typeof args[param.name] !== 'undefined') {
        ...
        if (param.in === 'query' && typeof param.collectionFormat !== 'undefined') {
...
Operation.prototype.asCurl = function (args1, args2) {
  ...
  if (obj.body && obj.method !== "GET" && obj.method !== "DELETE") {
    var body;
